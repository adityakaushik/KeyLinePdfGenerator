...
//					canvas.beginLayer(printLayer01);
	...
	void printLines(PdfCanvas canvas, List<LineValues> lineslist,
			double x,double y){
		for (LineValues lv : lineslist) {
			// //System.out.println("canvas.moveTo("+(lv.getStartX() +
			// x)+" , "+(lv.getStartY() + y)+");");
			canvas.moveTo((lv.getStartX() + x) *(3.7795275591),
					(lv.getStartY() + y) *(3.7795275591));

			// //System.out.println("canvas.lineTo("+(lv.getEndX() +
			// x)+" , "+(lv.getEndY() + y)+");");
			canvas.lineTo((lv.getEndX() + x) *(3.7795275591),
					(lv.getEndY() + y) *(3.7795275591));
	...
	void printCurves(PdfCanvas canvas, List<CurveValues> curveValueList,
		...
		for (CurveValues cv : curveValueList) {
			canvas.moveTo((cv.getStartX() + x) *(3.7795275591),
					(cv.getStartY() + y) *(3.7795275591));
			canvas.curveTo((cv.getStartX() + x) *(3.7795275591),
					(cv.getStartY() + y) *(3.7795275591),

					(cv.getCenterX() + x) *(3.7795275591),
					(cv.getCenterY() + y) *(3.7795275591),

					(cv.getEndX() + x) *(3.7795275591),
					(cv.getEndY() + y) *(3.7795275591));

			canvas.moveTo((cv.getEndX() + x) *(3.7795275591),
					(cv.getEndY() + y) *(3.7795275591));
		}
	}
